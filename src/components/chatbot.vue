<template>
    <div>
        <div @click="toggle=!toggle" class =" chat_msg">
        <img src = "@/assets/chat_icon.jpeg" alt = "chat_icon" height="70px" width="70px" padding = " 20px">
	</div>
	<div class = "chat_box1" :class="{'active':toggle}">
		<div class = "head1">
			<div class = "mindler_photo"><img src = "@/assets/logo.jpg"></div>
			<div class = " heading "> <h1 style="font-family:verdana;"> Hello </h1></div>
			<p>Welcome to the Mindler, India's No.1 site for Carrer Planning and Counsling </p>
		</div>
...
dasda
		...
		<div class="conv-form-wrapper">
			<form action=" " method="GET" class="">
                ...
                <input type="text" name="name" data-conv-question="welcome to the Mindler, tell me your full name, please.|Okay! Please, tell me your name first.">
                <input data-conv-question=" Howdy, {name}:0! pls enter  your e-mail" data-pattern="^[a-zA-Z0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+\.[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$" id="email" type="email" name="email" required placeholder="What's your e-mail?">
            <select name="studying" data-conv-question="What are you studying" multiple>
				<option value="Below_10">Below 10</option>
				<option value="plus_10">plus 10</option>
